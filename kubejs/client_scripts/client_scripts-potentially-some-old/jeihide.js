...
JEIEvents.hideItems(event => {
    ...
    'kubejs:cancelcraft',
      ...
      'iter_rpg:sky_flail',
      'iter_rpg:hell_flail', //Again, too many things repeating the same things in Epic Knight's mod!
      ...
      'moremekanismprocessing:zinc_ingot',
      'moremekanismprocessing:zinc_nugget', //this is a small bi-product of whats happening in the craft tweaks' scripts>examples>mekanism folder
