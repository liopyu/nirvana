PlayerEvents.loggedIn( event => {
  ...
  PlayerEvents.loggedIn( event => {
    const {player,server,player: {persistentData,username}} = event
    persistentData.putInt("arcanehLevel", 0)
    persistentData.putInt("crumblinghLevel", 0)
    persistentData.putInt("dentedhLevel", 0)
    persistentData.putInt("heavyhLevel", 0)
    persistentData.putInt("heavycLevel", 0)
    persistentData.putInt("masterfulhLevel", 0)
    persistentData.putInt("protectivehLevel", 0)
    persistentData.putInt("luckyhLevel", 0)
    persistentData.putInt("thickhLevel", 0)
    persistentData.putInt("toughhLevel", 0)
    persistentData.putInt("solidcLevel", 0)
    persistentData.putInt("cumbersomecLevel", 0)
    persistentData.putInt("arcanecLevel", 0)
    persistentData.putInt("crumblingcLevel", 0)
    persistentData.putInt("dentedcLevel", 0)
    persistentData.putInt("protectivecLevel", 0)
    persistentData.putInt("thickcLevel", 0)
    persistentData.putInt("toughcLevel", 0)
    persistentData.putInt("arcanelLevel", 0)
    persistentData.putInt("crumblinglLevel", 0)
    persistentData.putInt("dentedlLevel", 0)
    persistentData.putInt("heavylLevel", 0)
    persistentData.putInt("masterfullLevel", 0)
    persistentData.putInt("protectivelLevel", 0)
    persistentData.putInt("thicklLevel", 0)
    persistentData.putInt("toughlLevel", 0)
    persistentData.putInt("springylLevel", 0)
    persistentData.putInt("arcanebLevel", 0)
    persistentData.putInt("crumblingbLevel", 0)
    persistentData.putInt("dentedbLevel", 0)
    persistentData.putInt("heavybLevel", 0)
    persistentData.putInt("masterfulbLevel", 0)
    persistentData.putInt("protectivebLevel", 0)
    persistentData.putInt("thickbLevel", 0)
    persistentData.putInt("toughbLevel", 0)
    persistentData.putInt("tallbLevel", 0)
    persistentData.putInt("speedybLevel", 0)
    persistentData.putInt("masterfulcLevel", 0)
    })
    PlayerEvents.respawned( event => {
      const {player,server,player: {persistentData,username}} = event
      persistentData.putInt("arcanehLevel", 0)
