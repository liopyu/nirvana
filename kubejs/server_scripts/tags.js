...
/* ServerEvents.tags('block', event => {
    event.remove('dynamictrees:roots', [
        "dynamictrees:mangrove_roots"
    ])
    event.remove("dynamictrees:aerial_roots_rooty_soil", [
...
ServerEvents.tags('item', event => {
    ...
    event.add('forge:tools/forest', [
        ...
        'iter_rpg:earth_shovel',
        'iter_rpg:earth_pickaxe',
        'iter_rpg:earth_axe',
        'iter_rpg:earth_hoe',
    ...
    event.add('forge:tools/ocean', [
        'iter_rpg:water_sword',
        'iter_rpg:water_shovel',
        'iter_rpg:water_pickaxe',
        'iter_rpg:water_axe',
        'iter_rpg:water_hoe',
    ])
    ...
    event.add('forge:tools/sky', [
        'iter_rpg:air_sword',
        'iter_rpg:air_shovel',
        'iter_rpg:air_pickaxe',
        'iter_rpg:air_axe',
        'iter_rpg:air_hoe',
    ])
    event.add('forge:tools/hell', [
        'iter_rpg:fire_sword',
        'iter_rpg:fire_shovel',
        'iter_rpg:fire_pickaxe',
        'iter_rpg:fire_axe',
        'iter_rpg:fire_hoe',
    ...
    event.add('forge:chestplates', [
        ...
        'iter_rpg:void_armor_chestplate',
...
ServerEvents.tags('block', event => {
    ...
    /*  event.remove('doom:paxel_blocks', [
         '#minecraft:mineable/axe'
     ])
     event.remove('artifacts:mineable/digging_claws', [
         '#minecraft:mineable/axe'
     ]) */
