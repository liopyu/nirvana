...
function checkMaterialsTool(event) {
  let item = event.player.getHeldItem('main_hand')
  let goldindex = event.player.inventory.allItems.some(Ingredient.of("gold_ingot"))
  ...
  const materialsToCheck = [
    ...
    { item: flint, index: flintindex, name: "Flint", color: Color.GOLD },
    { item: argent_energy, index: argentindex, name: "Argent Plate", color: Color.GOLD },
    { item: atomic, index: atomicindex, name: "Atomic Alloy", color: Color.GOLD },
    { item: nautilus_shell, index: nautilus_shellindex, name: "Nautilus Shell", color: Color.GOLD },
    { item: awful, index: awfulindex, name: "Awful Crystal", color: Color.GOLD },
    { item: gobsteel, index: gobsteelindex, name: "Gobsteel Scrap", color: Color.GOLD },
    { item: arcane_powder, index: arcane_powderindex, name: "Arcane Powder", color: Color.GOLD },
    { item: stone, index: stoneindex, name: "Stone", color: Color.GOLD },
    { item: wooden, index: woodenindex, name: "Stick", color: Color.GOLD },
    { item: silver, index: silverindex, name: "Silver Ingot", color: Color.GOLD },
    { item: nether_brick, index: nether_brickindex, name: "Nether Brick", color: Color.GOLD },
    { item: amethyst, index: amethystindex, name: "Amethyst Shard", color: Color.GOLD },
    { item: emerald, index: emeraldindex, name: "Emerald", color: Color.GOLD },
    { item: obsidian, index: obsidianindex, name: "Obsidian", color: Color.GOLD },
    { item: infected, index: infectedindex, name: "Putrid Flesh", color: Color.GOLD },
    { item: ametrine, index: ametrineindex, name: "Ametrine Ingot", color: Color.GOLD },
    { item: nether_star, index: nether_starindex, name: "Nether Star", color: Color.GOLD },
    { item: chaos, index: chaosindex, name: "Seed Of Chaos", color: Color.GOLD },
    { item: ars, index: arsindex, name: "Source Gem", color: Color.GOLD },
    { item: knight, index: knightindex, name: "Knight Ingot", color: Color.GOLD },
    { item: deorum, index: deorumindex, name: "Deorum Ingot", color: Color.GOLD }
