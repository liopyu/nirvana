...
/*Jei.hideIngredient(<item:stalwart_dungeons:tungsten_shield>);
Jei.hideIngredient(<item:stalwart_dungeons:warted_tungsten_shield>);
Jei.hideIngredient(<item:stalwart_dungeons:chorundum_shield>);*/


//Jei.hideModIngredients("medieval_craft_weapons");
//Jei.hideModIngredients("medieval_craft_structures");
