...
//<recipetype:mekanism:smelting>.addRecipe("crushed_silver_to_silver_ingot", ItemStackIngredient.from(<item:create:crushed_silver_ore>), <item:moremekanismprocessing:silver_ingot>);
